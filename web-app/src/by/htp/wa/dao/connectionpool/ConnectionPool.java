...
import static by.htp.wa.dao.connectionpool.ConnectionPoolParam.DRIVER;
import static by.htp.wa.dao.connectionpool.ConnectionPoolParam.NAME;
import static by.htp.wa.dao.connectionpool.ConnectionPoolParam.PASS;
import static by.htp.wa.dao.connectionpool.ConnectionPoolParam.POOLSIZE;
import static by.htp.wa.dao.connectionpool.ConnectionPoolParam.URL;
...
public final class ConnectionPool {
	...
	private ConnectionPool() {
		...
		try {
			...
			LOGGER.log(Level.WARNING, "ClassNotFoundException in ConnectionPool", e);
		} catch (SQLException e) {
			LOGGER.log(Level.WARNING, "SQLException in ConnectionPool", e);
		}
	}
	...
	public void closeConnection(Connection con, PreparedStatement pst, ResultSet rs) {
		...
		try {
			...
			LOGGER.log(Level.WARNING, "ResultSet isn't return to the pool.");
		}

		try {
			pst.close();
		} catch (SQLException e) {
			LOGGER.log(Level.WARNING, "PreparedStatement isn't closed.");
		}
		try {
			con.close();
		} catch (SQLException e) {
			LOGGER.log(Level.WARNING, "Connection isn't closed.");
		}
	}
	...
	public void closeConnection(Connection con, PreparedStatement pst) {
		...
		try {
			...
			LOGGER.log(Level.WARNING, "PreparedStatement isn't return to the pool.");
		}
		try {
			con.close();
		} catch (SQLException e) {
